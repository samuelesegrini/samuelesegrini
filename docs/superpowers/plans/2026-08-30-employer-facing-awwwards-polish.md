...
- [ ] **Step 1: Record the existing draft-exclusion contract**
...
- [ ] **Step 2: Run the focused unit test to establish the seam**
...
- [ ] **Step 3: Add the static EasyManager cover**
...
- [ ] **Step 4: Write the English project entry**
...
- [ ] **Step 5: Write the idiomatic Italian entry with identical facts**
...
- [ ] **Step 6: Validate the draft content and site types**
...
- [ ] **Step 7: Commit the draft case study**
...
- [ ] **Step 1: Write failing rendered-route expectations**
...
- [ ] **Step 3: Extend `ProjectCard` without changing its visual hierarchy**
...
- [ ] **Step 4: Pass localized authorship and role from every card caller**
...
- [ ] **Step 5: Replace generic hero and placeholder profile copy**
...
- [ ] **Step 6: Style the authorship line and harden metadata size**
...
- [ ] **Step 1: Write the failing final-trio and pulse tests**
...
- [ ] **Step 2: Run the new final-trio test and verify red**
...
- [ ] **Step 3: Activate the complete bilingual trio atomically**
...
- [ ] **Step 4: Introduce the artwork dispatcher**
...
- [ ] **Step 5: Refactor the card link to permit valid controls**
...
- [ ] **Step 6: Implement the five-state service pulse**
...
- [ ] **Step 7: Add the static, interactive, and reduced-motion CSS states**
...
- [ ] **Step 8: Run focused content, E2E, accessibility, and type checks**
...
- [ ] **Step 9: Commit the final trio and signature interaction**
...
- [ ] **Step 1: Write failing treatment and reduced-motion tests**
...
- [ ] **Step 3: Implement the Galaxy network overlay**
...
- [ ] **Step 4: Implement the SpinGO route overlay**
...
- [ ] **Step 5: Route treatments through the single dispatcher**
...
- [ ] **Step 3: Enable Astro's progressive router**
...
- [ ] **Step 4: Assign stable shared-object names**
...
- [ ] **Step 5: Add the minimal reveal controller**
...
- [ ] **Step 6: Add reveal hooks without changing page composition**
...
- [ ] **Step 7: Verify route, history, reduced motion, and accessibility behavior**
...
- [ ] **Step 1: Write failing launch-check unit tests**
...
- [ ] **Step 2: Run the focused launch test and verify red**

Run: `npm test -- scripts/launch-readiness.test.ts`

Expected: FAIL because the script does not export `collectLaunchFailures`.

- [ ] **Step 3: Refactor the launch command without changing its CLI contract**
...
- [ ] **Step 4: Add responsive shared-shell assertions**
...
- [ ] **Step 5: Apply the bounded CSS polish**
...
- [ ] **Step 6: Confirm launch remains honestly blocked**
...
- [ ] **Step 1: Stop or identify stale preview servers**
...
- [ ] **Step 4: Invoke `/code-review` against the fixed point**
...
- [ ] **Step 5: Fix every valid finding test-first**
...
- [ ] **Step 6: Confirm repository state and commit review fixes**
