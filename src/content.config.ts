...
const labCopy = defineCollection({
	...
	schema: z.object({
		...
		footer: z.object({ apertura: z.string().min(1), invito: z.string().min(1), risposta: z.string().min(1), scrivimi: z.string().min(1), navigazione: z.string().min(1), altrove: z.string().min(1), colofone: z.string().min(1), fattoCon: z.string().min(1), caratteri: z.string().min(1), diritti: z.string().min(1), lingua: z.string().min(1) }),
